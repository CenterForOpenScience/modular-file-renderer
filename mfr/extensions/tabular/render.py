...
import mfr
import os
from .configuration import _config as config
...
class TabularRenderer:
    ...
    def render(self):
        ...
        #    return self.render_html(fp)

    @property
    def requires_file(self):
        return True

    # def populate_data(self, fp):
    ...
    #
    # def render_html(self, fp, src=None):
    ...
    #     """
    #
    #     columns, rows = self.populate_data(fp)
    #
