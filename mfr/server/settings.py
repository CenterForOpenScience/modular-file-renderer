...
LOCAL_CACHE_PROVIDER_SETTINGS = config.get_object(
    "LOCAL_CACHE_PROVIDER_SETTINGS", {"folder": "/tmp/mfrlocalcache/"}
)

ALLOWED_PROVIDER_DOMAINS = config.get(
    "ALLOWED_PROVIDER_DOMAINS", "http://localhost:5000/ http://localhost:7777/"
).split(" ")
