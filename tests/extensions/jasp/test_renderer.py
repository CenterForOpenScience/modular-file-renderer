...
def metadata():
    return ProviderMetadata(
        ...
        "1234",
        "http://wb.osf.io/file/JASP.jasp?token=1234",
    )
...
class TestCodeJASPRenderer:
    ...
    def test_render_JASP_no_data_archive_version_in_manifest(
        self,
        metadata,
        no_data_archive_version_in_manifest_path,
        url,
        assets_url,
        export_url,
    ):
    ...
    def test_render_JASP_data_archive_is_too_old(
        self,
        metadata,
        data_archive_version_is_too_old_path,
        url,
        assets_url,
        export_url,
    ):
    ...
    def test_render_JASP_no_index_html(
    ...
    def test_render_JASP_contains_malicious_script(
        ...
        renderer = JASPRenderer(
            metadata, contains_malicious_script_path, url, assets_url, export_url
        )
        body = renderer.render()
