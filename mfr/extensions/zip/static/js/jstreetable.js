 ...
 * MFR Customizations:
 *
 * "jstreetable.js" doesn't have a min version and the comments doesn't provide the release number.
 * MFR uses 4.0.0: https://raw.githubusercontent.com/adamjimenez/jstree-table/4.0.0/jstreetable.js.
 * There is no functional customization of the file except linting updates.  Please refer to the
 * ".eslintrc.json" in the MFR root for more information.
 */
            ...
            this.element
                ...
                .on("ready.jstree",$.proxy(function (e,data) {
                    ...
                    function resize() {
                        ...
                        $("<style type=\"text/css\" id=\"jsTreeTableExtraCss\">div.jstree-table-cell-root-"+me.rootid+" {line-height: "+anchorHeight+"px; min-height: "+anchorHeight+"px;}div.jstree-table-midwrapper a.jstree-clicked:before, .jstree-table-midwrapper a.jstree-hovered:before {width: " + tableWidth + "px;}</style>").appendTo("head");
                    }
